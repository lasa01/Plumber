...
class ApiImporter:
    ...
    def add_vmf_job(self, path: str, from_game: bool, **kwargs) -> None: ...
    def add_mdl_job(self, path: str, from_game: bool, **kwargs) -> None: ...
    def add_vmt_job(self, path: str, from_game: bool) -> None: ...
    def add_vtf_job(self, path: str, from_game: bool) -> None: ...
